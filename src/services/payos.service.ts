...
export class PayOSService {
    ...
    static async createPaymentLink(
        ...
        const result = await payos.paymentRequests.create({
            ...
            returnUrl: process.env.PAYMENT_RETURN_URL || "http://localhost:3000/account/billing?payment=success",
            cancelUrl: process.env.PAYMENT_CANCEL_URL || "http://localhost:3000/account/billing?payment=cancelled",
        });
